...
def user_input_features():
  ...
  Tiempo_invertido = st.number_input('Tiempo invertido:', min_value=1, max_value=1440, value = 1, step = 1)
  Tipo = st.number_input("Tipo \n0.Entretenimiento ocio \n1.Ahorro inversion \n2.Ejercicio Deporte \n3.Alimentos salud \n4.Transporte \n5.Academico:", min_value=0, max_value=5, value = 0, step = 1)
  Momento = st.number_input("Momento \n0.mañana \n1.tarde \n2.noche:",min_value=0, max_value=2, value = 0, step = 1)
...
b1 = LR.coef_
b0 = LR.intercept_
prediccion = b0 + b1[0]*df2['Presupuesto'] + b1[1]*df2['Tiempo invertido'] + b1[2]*df2['Tipo'] + b1[3]*df2['Momento'] + b1[4]*df2['No. de personas']
